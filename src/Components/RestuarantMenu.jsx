...
const RestaurantMenu = () => {
  ...
  return (
    <div className='p-6 bg-gray-300 h-auto w-full lg:w-8/12 m-auto rounded-md my-8'>
      <div className='bg-gray-100 shadow-lg rounded-lg overflow-hidden flex flex-col lg:flex-row justify-center py-6'>
        <img
          className='w-full lg:w-1/4 h-auto object-cover rounded-xl'
      ...
      <div className='mt-8'>
        <div
          className='flex justify-between items-center cursor-pointer shadow-xl my-3 px-2 rounded-lg'
          onClick={handleData}>
